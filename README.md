...
So far a few commands work. Still learning how to interface with the machine and the kernel effectively.
Really struggling with directories at this time, so the cd command is inoperative. 
